      ...
      <div className="container mx-auto px-4 relative z-10">
              ...
              {[
               { Icon: Instagram, href: "https://www.instagram.com/acm_svkmiot/" },
                ...
                <a
                  key={index}
                  href={href}
                  className="w-12 h-12 rounded-full border border-primary/30 bg-glass/30 backdrop-blur-sm flex items-center justify-center text-primary hover:bg-primary hover:text-background hover:shadow-[0_0_20px_hsl(var(--neon-blue)/0.5)] transition-all duration-300"
                >
        ...
        <div className="pt-8 border-t border-primary/20 text-center">
          <p className="text-sm text-muted-foreground">
            © 2025 SVKM IOT ACM Student Chapter. All rights reserved.
          </p>
